...
static char titlenormfgcolor[]           = "#ffffff"; // Normal title bar text color (foreground).
static char titlenormbgcolor[]           = "#5f5f5f"; // Normal title bar background color.
static char titlenormbordercolor[]       = "#444444"; // Normal title bar border color.
static char titlenormfloatcolor[]        = "#000000"; // Normal title bar color for floating windows.
...
static char titleselbordercolor[]        = "#005577"; // Selected title bar border color.
static char titleselfloatcolor[]         = "#005577"; // Selected title bar color for floating windows.
...
static char tagsselbordercolor[]         = "#005577"; // Selected tag border color.
static char tagsselfloatcolor[]          = "#005577"; // Selected tag color for floating windows.
...
static const int color_ptrs[][ColCount] = {
	[SchemeNorm]         = { -1,     0,      0,      7 }, // normfgcolor, normbgcolor, normbordercolor, normfloatcolor
	...
	[SchemeTitleSel]     = { 7,      0,     -1,     -1 }, // titleselfgcolor, titleselbgcolor, titleselbordercolor, titleselfloatcolor
	[SchemeTagsNorm]     = { 7,      0,      0,      -1 }, // tagsnormfgcolor, tagsnormbgcolor, tagsnormbordercolor, tagsnormfloatcolor
	[SchemeTagsSel]      = { 10,     0,      -1,    -1 }, // tagsselfgcolor, tagsselbgcolor,   tagsselbordercolor, tagsselfloatcolor
...
static const Launcher launchers[] = {
	/* icon to display      command        */
        { "w",               CMD("mullvad-browser", "https://dwm.suckless.org") },
        { "m",               CMD("st", "-e", "ncmpcpp") },
...
static const char *dmenucmd2[] = { "spmenu", NULL };
static const char *dmenucmd3[] = { "/bin/sh", "-c", "/home/hexe/spmenu3", "-e", NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *termcmd2[]  = { "terminator", NULL };
static const char *instoggle[] = { "sh", "/home/hexe/sxhkdrc.sh", "-t", NULL };
...
static const Key keys[] = {
	...
	{ ControlMask|ShiftMask,             XK_space,      focusmaster,            {0} },
	...
	{ MODKEY|ShiftMask,                       XK_t,          transfer,               {0} },
	{ MODKEY|ShiftMask|ControlMask,           XK_t,          transferall,            {0} },
